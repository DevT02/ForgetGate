\begin{table}[t]
  ...
  \begin{tabular}{l l l c c c}
    ...
    Uniform KL & 42 & 32$\times$32 conditional patch & 15.6\% & 0.0\% & 0.15234 \\
    ...
    SGA & 42 & 32$\times$32 conditional patch & 0.0\% & 0.0\% & N/A \\
    SGA & 42 & 2-step baseline pilot & 75.0\% & 0.0\% & 0.00417 \\
    SGA & 42 & 2-step stage-2 pilot & 62.5\% & 0.0\% & 0.00441 \\
    \bottomrule
  \end{tabular}
  }
  \caption{Auxiliary seed-sensitive targets. Uniform KL is a bridge case between the older probe regime and the newer conditional-recovery regime, while SGA behaves like generic adversarial fragility under the full audit, stays patch-negative, and only shows a weak fast-pilot stage-2 effect.}
