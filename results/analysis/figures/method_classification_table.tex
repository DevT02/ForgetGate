\begin{table}[t]
  ...
  \begin{tabular}{l l l l}
    ...
    SGA & adapted recent method & main text & auxiliary cross-domain benchmark row \\
  ...
  \caption{Method classification used in this draft. This table fixes the distinction between literature anchors, recent or adapted benchmark rows, appendix-only supporting rows, and proxy or invalid rows so that the paper does not mix benchmark evidence with convenience artifacts.}
