\begin{table}[t]
  ...
  \begin{tabular}{l l c c c c}
    ...
    \bottomrule
  \end{tabular}
  \caption{Short-budget comparison between matched 2-step Adam and the learned distilled conditional attacker. The learned attacker helps most on ORBIT, helps on SalUn with a weaker forget/retain Pareto, and does not remain selective on RURK. All rows report metrics over $n=32$ audit samples per class.}
